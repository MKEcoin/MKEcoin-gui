...
function getApproximateBlockchainHeight(_date, _nettype){
    // time of MKEcoin birth 2014-04-18 10:49:53 (1397818193)
    var MKEcoinBirthTime = _nettype == "Mainnet" ? 1397818193 : _nettype == "Testnet" ? 1410295020 : 1518932025;
    ...
    var secondsPerBlock;
    // before MKEcoin's birth
    if (requestedTime < MKEcoinBirthTime){
        console.log("Calculated blockchain height: 0, requestedTime < MKEcoinBirthTime " );
        return 0;
    }
    // time between during v1
    if (requestedTime > MKEcoinBirthTime && requestedTime < forkTime){
        approxBlockchainHeight = Math.floor((requestedTime - MKEcoinBirthTime)/secondsPerBlockV1);
